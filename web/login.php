                    ...
                    <div class="panel-body">
                        <form role="form" method="POST" action="check-login.php">
                            <fieldset>
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input name="remember" type="checkbox" value="Remember Me">Passwort speichern
                                    </label>
                                </div>
                                <!-- Change this to a button or input when using this as a form -->
                                <input type=submit name=login value="Anmelden" class="btn btn-lg btn-success btn-block">
                            </fieldset>
                        </form>
                    </div>
                </div>
