...
?>
  <div class="row">
    ...
    <table cellspacing=1 border=1>
      <tr><td>
        <div id="stream" onmousemove="setTimeout(mousemove(event), 500);" oncontextmenu="alert('Drücken sie STRG und bewegen sie gelichzeitig die Maus in dem Stream, um sich um zu schauen.');return false">
